class SocketRequest {
  ...
  /**
   * Manage a socket.
   * @param {Socket} requestSocket Socket generated by Socket.io
   * @returns {SocketRequest} SocketRequest instance.
   */
  ...
  /**
   * Register the update emitter.
   * @param {Function} updateHandler Function to handle update requests.
   */
  ...
  /**
   * Register the success emitter.
   * @param {Object} updatedData Object to emit.
   */
  updated (updatedData) {
  ...
  /**
   * Register the failure emitter.
   * @param {Errpr} stagnatedReason Reason for failure.
   */
  ...
  /**
   * Register the join broadcaster.
   * @param {Object} joinClient Client to broadcast.
   */
  join (joinClient) {
  ...
  /**
   * Register the change broadcaster.
   * @param {Object} changeClient Client to broadcast.
   */
  change (changeClient) {
  ...
  /**
   * Register the leave broadcaster.
   * @param {Object} leaveClient Client to broadcast.
   */
  leave (leaveClient) {
